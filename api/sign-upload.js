// POST /api/sign-upload — one-time signed URL to upload a license photo to private Supabase Storage.
// Body: {application_id | reference, slot, filename}
import { findByRef, cleanRef } from './_lib/db.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const r = await fetch(`${url}/storage/v1/object/upload/sign/applicant-documents/${path}`, { method: 'POST', headers: { apikey: key, Authorization: 'Bearer ' + key } });
